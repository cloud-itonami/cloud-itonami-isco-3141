(ns field-lab-science-support.advisor
  "SamplingAdvisor — proposes a field-and-lab-science-support
  operation (collect a sample, analyze a sample, operate near
  research subjects, operate near a protected site or water source)
  ...
  of project provenance or research-subject/protected-site risk;
  `field-lab-science-support.governor` is the independent system that
  decides whether the proposal may proceed, per the itonami actor
  pattern.

  A proposal is a map:
    {:op :sample|:analyze|:operate-near-research-subjects|:operate-near-protected-site
...
(def ^:private system-prompt
  "You are a field-and-lab-science-support advisor. Given a sampling
   operation request, propose an :op, an honest :confidence
